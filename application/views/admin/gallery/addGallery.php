                    ...
                    <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="image-title" name="image-title" placeholder="Choose Image Title" value="<?php echo esc(set_value('image-title'), true)?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea id="service-content" name="image-content" class="form-control" placeholder="Choose Image Short Description"><?php echo esc(set_value('image-content'), true)?></textarea>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                            ...
                            <div class="card-footer">
                                <div class="form-group text-right">
                                    ...
                                    <button class="btn btn-success"><i class="fas fa-save mr-1"></i> Add Image</button>
                                </div>
                            </div>
                        </div>
                    </form>
