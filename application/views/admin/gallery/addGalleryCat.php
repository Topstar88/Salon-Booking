                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="category-name" placeholder="Gallery category name" value="<?php echo set_value('category-name')?>">
                                </div>
                            ...
                            <div class="card-footer">
                                <div class="form-group text-right">
                                    ...
                                    <a href="<?php anchor_to(GALLERY_CONTROLLER . '/categories'); ?>" class="btn btn-danger text-white mr-4"><i class="fas fa-arrow-left mr-1"></i> Back</a>
